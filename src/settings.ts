...
export type WorkspaceView = 'spatial' | 'plan' | 'camera';
...
export const useSettings = create<Settings>()(persist((set) => ({
  planTool: 'select', workspaceView: 'spatial', positionSnap: 0, rotationSnap: 0, language: 'en', showLabels: false, layout: defaultLayout, maximized: null, frameRequest: 0, navigating: false,
