...
export const useSettings = create<Settings>()(persist((set) => ({
  language: 'en', showLabels: false, layout: defaultLayout, maximized: null, frameRequest: 0, navigating: false,
...
}), { name: 'ssd-preferences-v02', partialize: s => ({ language: s.language, showLabels: s.showLabels, layout: s.layout }) }));
